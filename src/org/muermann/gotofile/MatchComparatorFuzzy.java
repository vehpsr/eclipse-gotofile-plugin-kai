 ...
 * @author max
 */
public class MatchComparatorFuzzy implements Comparator<SearchResult> {
    ...
    public int compare(SearchResult r1, SearchResult r2) {
        ...
        if (r1.getMatchConsecutiveName() > r2.getMatchConsecutiveName())
            return -1;
        if (r2.getMatchConsecutiveName() > r1.getMatchConsecutiveName())
            return 1;
